...
for (const file of ['generated-v1','cookies-and-chips-logo.png','logo-package/masters/cookie-icon.png']) cpSync('docs/brand/'+file,'public/brand/'+file,{recursive:true});
