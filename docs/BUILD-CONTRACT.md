...
The owner requests online commerce with PayPal and customer accounts, story/products/Cookie of the Month/reviews, dynamic categories/subcategories/collections and strict project isolation. The supplied conversation includes a logo and Instagram screenshot attachment, but no inspected, versioned approved page designs. Prior assistant copy, page lists, guest-checkout recommendations and sample products/prices are proposals only. Preserve them as context, not production content. No approved visual specification has been recovered.

## Exact next work, in order

1. **Complete business/product intake.** Obtain launch catalog, variants, quantities, prices/currency, product photography, food/pet product information, stock versus made-to-order rules, supported fulfillment areas/methods, charges, lead times/cutoffs/timezone, refund/cancellation rules, contact details, domain ownership and actual story/reviews. Confirm account-required versus guest checkout: the owner's original account request and assistant's guest suggestion are unresolved. Decide monthly feature behavior, review collection/moderation, admin scope and V1 exclusions (subscriptions, build-a-box, discounts, gift cards, favorites, delivery, social feeds).
